...
class QAgent(AgentInterface):
    ...
    def __init__(self, space : SpaceInvaders, eps_profile: EpsilonProfile, gamma: float, alpha: float):
        ...
        self.Q = np.zeros([SpaceInvaders.get_state(), SpaceInvaders.na])   #Peut-etre la sauce pour le state
    ...
    def learn(self, space, n_episodes, max_steps):
        ...
        for episode in range(n_episodes):
            ...
            for step in range(max_steps):
                ...
                next_state, reward, terminal = space.step(action)
    ...
    def save_log(self, space, episode):
